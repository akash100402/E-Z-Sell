  ...
  return (
    <div className="w-72 flex flex-col mt-4">
      <div className="flex justify-between">
        <h1 className="text-amber-500  text-xl">Filters</h1>
        <i
          className="ri-close-line rounded-md text-xl cursor-pointer"
          onClick={() => setShowFilters(!showFilters)}
        ></i>
      </div>

      <div className="flex flex-col gap-1 mt-5">
        <h1 className="text-gray-700"><u>Categories</u></h1>
        ...
        <h1 className="text-gray-600 mt-5"><u>Product Age</u></h1>
